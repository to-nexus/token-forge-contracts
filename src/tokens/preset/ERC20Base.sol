...
abstract contract ERC20Base is IERC20Forge, ERC165Upgradeable, ERC20Upgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function __ERC20Preset_init(
        ...
        ERC20BaseStorage storage _$ = _getERC20PresetStorage();
        _$.decimals = _decimals;
        _$.forge = _forge;
        if (_initialSupply != 0) {
    ...
    function mint(address to, uint256 amount) public virtual onlyForge {
        _mint(to, amount);
    }
