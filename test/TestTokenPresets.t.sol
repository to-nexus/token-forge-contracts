...
contract TestTokenPresets is Test {
    ...
    function test_erc20_mintable() external {
        ...
        ERC20Mintable erc20 = ERC20Mintable(
            tokenFactory.deployERC20(
                SERVICE_OWNER, SERVICE_OWNER, "ERC20Mintable", "ERC20M", 18, 0, SERVICE_OWNER, "", address(logic)
            )
        );
    ...
    function test_erc20_fixed() external {
        ...
        ERC20Fixed erc20 = ERC20Fixed(
            tokenFactory.deployERC20(
                SERVICE_OWNER, SERVICE_OWNER, "ERC20Fixed", "ERC20F", 18, 0, SERVICE_OWNER, "", address(logic)
            )
        );
        ...
        erc20 = ERC20Fixed(
            tokenFactory.deployERC20(
                SERVICE_OWNER, SERVICE_OWNER, "ERC20Fixed", "ERC20F", 18, 1000e18, SERVICE_OWNER, "", address(logic)
            )
        );
